        ...
        m = function(e) {
            ...
            if (d) {
                for (var g = m.length, A = 0; A < l.numPosts && A !== g; A++) {
                    ...
                    c += '<li class="related-li"><a title="' + n + '" href="' + a + '"><img alt="" id="related-post-item-thumbnail" src="' + i + '" width="" height="" /></a><div id="content"><h4 class="related-post-item-title"><a title="' + n + '" href="' + a + '">' + r + '</a></h4><p class="related-post-item-summary">' + s + '</p></div><div class="related-post-item-more"><a href="' + a + '">' + l.moreText + "</a></div><div class='clear'/></li>"
                }
